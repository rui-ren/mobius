...
description: >
  Use this skill when managing parallel workstreams across multiple AI agents
  on a shared Git repository. Covers worktree isolation to prevent merge
  conflicts, commit coordination protocols, verification gates between
  dependent tasks, context management for stateless agents, and failure
  recovery patterns. Based on real experience coordinating 10–17 agents
  simultaneously.
---
